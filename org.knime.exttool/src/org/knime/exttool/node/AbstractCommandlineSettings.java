...
public abstract class AbstractCommandlineSettings {
    ...
    /** Determine output spec during node-configuration. Sub-classes may
     * overwrite this method if they can determine the output spec already at
     * configuration time. Note that output spec refers to the table spec
     * generated by the external tool (including the ID column, which will
     * eventually be removed from the final result), not the final output
     * spec of the node. Joining this output spec (if it exists) with the
     * input spec will be done in the Node's configure method.
     * <p>
     * This default implementation returns null (no-op).
     * @param specs The input specs.
     * @return The calculated output specs (or null).
