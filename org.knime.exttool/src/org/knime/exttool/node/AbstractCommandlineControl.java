...
public abstract class AbstractCommandlineControl {
    ...
    /** Called prior to the save routine to allow this control object to set
     * some configuration parameters in the main settings object. This can be
     * useful, for instance if subclasses also list the input/output types and
     * need to set these in the global configuration.
     * @param settings Where to change some parameters.
    ...
    protected void saveGlobalSettingsGlobal(final ExttoolSettings settings)
        throws InvalidSettingsException {
        // default implementation does not change input/output
    }
}
