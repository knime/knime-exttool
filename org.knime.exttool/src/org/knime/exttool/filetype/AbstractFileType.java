...
public abstract class AbstractFileType {
    ...
    public final String getSuffix() {
        return m_factory.getSuffix();
    }

    /** Get the label that's shown to the user.
     * @return The suffix as in
     *         {@link AbstractFileTypeFactory#getUserFriendlyName()} */
    public final String getUserFriendlyName() {
        return m_factory.getUserFriendlyName();
    }
